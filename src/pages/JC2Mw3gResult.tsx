...
import altImg from "@/assets/celeb-39-alt.png";
  ...
  return (
    <>
      <Seo
        ...
        description="The answer reveal for The Fame Game Quiz 39."
            ...
            <CardContent className="p-8 text-center space-y-4">
              ...
              <div className="flex justify-center">
                <img
                  ...
                  alt={isAlt ? "Celebrity: John Cena" : "Celebrity: Jennifer Aniston"}
                  loading="lazy"
                  className="w-40 h-40 rounded-full object-cover ring-4 ring-primary/30 p-1 bg-background animate-fade-in"
                />
              </div>
              <p className="text-xl font-bold">{isAlt ? "John Cena" : "Jennifer Aniston"}</p>
            </CardContent>
          </Card>
        </section>
      </main>
